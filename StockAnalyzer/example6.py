            ...
            for file in each_file:
                ...
                try:
                    ...
                    try:
                        ...
                        #print(sp500_date, sp500_df["Date"][sp500_df.index])
                        row = sp500_df[(sp500_df["Date"][sp500_df.index] == sp500_date)]
                        #print(row)
                    ...
                    try:
                        ...
                        row = sp500_df[(sp500_df["Date"][sp500_df.index] == sp500_1y)]
                    ...
                    try:
                        ...
                        stock_1y_value = round(float(stock_loc), 2)
                    except Exception as e:
                        try:
